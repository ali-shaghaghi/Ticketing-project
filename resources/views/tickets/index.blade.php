                ...
                <div class="card m-b-30 m-t-30">
                    <div class="card-body">
                        <div class="justify-content-between m-b-10" style="display: flex;">
                            ...
                            <div class="text-left">
                                <a href="{{route('tickets.create')}}" class="btn btn-light waves-effect">
                                    <i class="mdi mdi-plus p-10" ></i><br/>جدید
                                </a>
                            </div>
                        </div>
                            ...
                            @foreach($tickets as $ticket)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-warning" href="{{route('tickets.show', $ticket->id)}}">بازدید</a>
                                    </td>
                                </tr>
